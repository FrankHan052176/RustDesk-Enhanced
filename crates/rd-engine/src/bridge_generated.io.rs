...
#[unsafe(no_mangle)]
pub extern "C" fn wire_main_configure_ohos_host_display(
    port_: i64,
    width: usize,
    height: usize,
    display_id: u64,
) {
    wire_main_configure_ohos_host_display_impl(port_, width, height, display_id)
}

#[unsafe(no_mangle)]
pub extern "C" fn wire_main_set_ohos_host_clipboard_enabled(port_: i64, enabled: bool) {
    wire_main_set_ohos_host_clipboard_enabled_impl(port_, enabled)
}

#[unsafe(no_mangle)]
pub extern "C" fn wire_main_update_ohos_host_clipboard_text(
    port_: i64,
    text: *mut wire_uint_8_list,
) {
    wire_main_update_ohos_host_clipboard_text_impl(port_, text)
}

#[unsafe(no_mangle)]
pub extern "C" fn wire_main_take_ohos_host_clipboard_text(port_: i64) {
    wire_main_take_ohos_host_clipboard_text_impl(port_)
}

#[unsafe(no_mangle)]
pub extern "C" fn wire_main_start_ohos_host(port_: i64) {
    wire_main_start_ohos_host_impl(port_)
}

#[unsafe(no_mangle)]
pub extern "C" fn wire_main_stop_ohos_host(port_: i64) {
    wire_main_stop_ohos_host_impl(port_)
}

#[unsafe(no_mangle)]
pub extern "C" fn wire_main_ohos_host_is_started() -> support::WireSyncReturn {
    wire_main_ohos_host_is_started_impl()
}
...
#[unsafe(no_mangle)]
pub extern "C" fn wire_cm_close_connection_window(port_: i64, conn_id: i32) {
    wire_cm_close_connection_window_impl(port_, conn_id)
}
