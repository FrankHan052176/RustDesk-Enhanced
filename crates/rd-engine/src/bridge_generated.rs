...
fn wire_main_configure_ohos_host_display_impl(
    port_: MessagePort,
    width: impl Wire2Api<usize> + UnwindSafe,
    height: impl Wire2Api<usize> + UnwindSafe,
    display_id: impl Wire2Api<u64> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool>(
        WrapInfo {
            debug_name: "main_configure_ohos_host_display",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            ...
            move |task_callback| {
                Ok(main_configure_ohos_host_display(
                    api_width,
                    api_height,
                    api_display_id,
                ))
...
fn wire_main_set_ohos_host_clipboard_enabled_impl(
    port_: MessagePort,
    enabled: impl Wire2Api<bool> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "main_set_ohos_host_clipboard_enabled",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_enabled = enabled.wire2api();
            move |task_callback| Ok(main_set_ohos_host_clipboard_enabled(api_enabled))
        },
    )
}
fn wire_main_update_ohos_host_clipboard_text_impl(
    port_: MessagePort,
    text: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool>(
        WrapInfo {
            debug_name: "main_update_ohos_host_clipboard_text",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_text = text.wire2api();
            move |task_callback| Ok(main_update_ohos_host_clipboard_text(api_text))
        },
    )
}
fn wire_main_take_ohos_host_clipboard_text_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Option<String>>(
        WrapInfo {
            debug_name: "main_take_ohos_host_clipboard_text",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(main_take_ohos_host_clipboard_text()),
    )
}
fn wire_main_start_ohos_host_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_start_ohos_host",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(main_start_ohos_host()),
    )
}
fn wire_main_stop_ohos_host_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_stop_ohos_host",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(main_stop_ohos_host()),
    )
}
fn wire_main_ohos_host_is_started_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
            debug_name: "main_ohos_host_is_started",
            port: None,
            mode: FfiCallMode::Sync,
        },
        move || Ok(main_ohos_host_is_started()),
    )
}
...
fn wire_cm_close_connection_window_impl(
    port_: MessagePort,
    conn_id: impl Wire2Api<i32> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        WrapInfo {
            debug_name: "cm_close_connection_window",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_conn_id = conn_id.wire2api();
            move |task_callback| Ok(cm_close_connection_window(api_conn_id))
        },
    )
}
