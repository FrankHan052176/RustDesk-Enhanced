    ...
    impl Shared {
        ...
        pub fn submitted_at(
            ...
            if let Some(micros) = elapsed_micros {
                ...
                s.stats.pipeline_micros_total =
                    s.stats.pipeline_micros_total.saturating_add(micros);
        ...
        pub fn output(&self, frame: bool, eos: bool) {
            ...
            if frame {
                ...
                if let Some(arrived) = s.pending_latency.pop_front() {
                    ...
                    s.stats.render_micros_total =
                        s.stats.render_micros_total.saturating_add(micros);
