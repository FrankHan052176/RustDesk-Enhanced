...
#define MOUSE_TYPE_TRACKPAD 4

#define MOUSE_TYPE_MOVE_RELATIVE 5

#define MOUSE_TYPE_MASK 7

#define MOUSE_BUTTON_LEFT 1

#define MOUSE_BUTTON_RIGHT 2

#define MOUSE_BUTTON_WHEEL 4
...
#define OEM_NEC_EQUAL 146

#define VOLUME_MUTE 173

#define VOLUME_DOWN 174

#define VOLUME_UP 175
 ...
 */
#define NATIVE_INPUT_IMPLEMENTED true

#define NATIVE_BACKEND_IMPLEMENTED true
...
void wire_main_configure_ohos_host_display(int64_t port_,
                                           uintptr_t width,
                                           uintptr_t height,
                                           uint64_t display_id);

void wire_main_set_ohos_host_clipboard_enabled(int64_t port_, bool enabled);

void wire_main_update_ohos_host_clipboard_text(int64_t port_, struct wire_uint_8_list *text);

void wire_main_take_ohos_host_clipboard_text(int64_t port_);

void wire_main_start_ohos_host(int64_t port_);

void wire_main_stop_ohos_host(int64_t port_);

WireSyncReturn wire_main_ohos_host_is_started(void);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_main_configure_ohos_host_display);
    dummy_var ^= ((int64_t) (void*) wire_main_set_ohos_host_clipboard_enabled);
    dummy_var ^= ((int64_t) (void*) wire_main_update_ohos_host_clipboard_text);
    dummy_var ^= ((int64_t) (void*) wire_main_take_ohos_host_clipboard_text);
    dummy_var ^= ((int64_t) (void*) wire_main_start_ohos_host);
    dummy_var ^= ((int64_t) (void*) wire_main_stop_ohos_host);
    dummy_var ^= ((int64_t) (void*) wire_main_ohos_host_is_started);
