...
abstract class Rustdesk {
  ...
  Future<bool> mainConfigureOhosHostDisplay(
      {required int width,
      required int height,
      required int displayId,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainConfigureOhosHostDisplayConstMeta;

  Future<void> mainSetOhosHostClipboardEnabled(
      {required bool enabled, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainSetOhosHostClipboardEnabledConstMeta;

  Future<bool> mainUpdateOhosHostClipboardText(
      {required String text, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainUpdateOhosHostClipboardTextConstMeta;

  Future<String?> mainTakeOhosHostClipboardText({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainTakeOhosHostClipboardTextConstMeta;

  Future<String> mainStartOhosHost({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainStartOhosHostConstMeta;

  Future<String> mainStopOhosHost({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainStopOhosHostConstMeta;

  bool mainOhosHostIsStarted({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainOhosHostIsStartedConstMeta;
...
class RustdeskImpl implements Rustdesk {
  ...
  Future<bool> mainConfigureOhosHostDisplay(
    ...
    var arg2 = _platform.api2wire_u64(displayId);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_main_configure_ohos_host_display(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_bool,
      constMeta: kMainConfigureOhosHostDisplayConstMeta,
      argValues: [width, height, displayId],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainConfigureOhosHostDisplayConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_configure_ohos_host_display",
        argNames: ["width", "height", "displayId"],
      );
  ...
  Future<void> mainSetOhosHostClipboardEnabled(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_main_set_ohos_host_clipboard_enabled(port_, arg0),
      parseSuccessData: _wire2api_unit,
      constMeta: kMainSetOhosHostClipboardEnabledConstMeta,
      argValues: [enabled],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta
      get kMainSetOhosHostClipboardEnabledConstMeta =>
          const FlutterRustBridgeTaskConstMeta(
            debugName: "main_set_ohos_host_clipboard_enabled",
            argNames: ["enabled"],
          );
  ...
  Future<bool> mainUpdateOhosHostClipboardText(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_main_update_ohos_host_clipboard_text(port_, arg0),
      parseSuccessData: _wire2api_bool,
      constMeta: kMainUpdateOhosHostClipboardTextConstMeta,
      argValues: [text],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta
      get kMainUpdateOhosHostClipboardTextConstMeta =>
          const FlutterRustBridgeTaskConstMeta(
            debugName: "main_update_ohos_host_clipboard_text",
            argNames: ["text"],
          );
  ...
  Future<String?> mainTakeOhosHostClipboardText({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_main_take_ohos_host_clipboard_text(port_),
      parseSuccessData: _wire2api_opt_String,
      constMeta: kMainTakeOhosHostClipboardTextConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainTakeOhosHostClipboardTextConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_take_ohos_host_clipboard_text",
        argNames: [],
      );

  Future<String> mainStartOhosHost({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_main_start_ohos_host(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kMainStartOhosHostConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainStartOhosHostConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_start_ohos_host",
        argNames: [],
      );

  Future<String> mainStopOhosHost({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_main_stop_ohos_host(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kMainStopOhosHostConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainStopOhosHostConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_stop_ohos_host",
        argNames: [],
      );

  bool mainOhosHostIsStarted({dynamic hint}) {
    return _platform.executeSync(FlutterRustBridgeSyncTask(
      callFfi: () => _platform.inner.wire_main_ohos_host_is_started(),
      parseSuccessData: _wire2api_bool,
      constMeta: kMainOhosHostIsStartedConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainOhosHostIsStartedConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_ohos_host_is_started",
        argNames: [],
      );
...
class RustdeskWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_main_configure_ohos_host_displayPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.UintPtr, ffi.UintPtr,
              ffi.Uint64)>>('wire_main_configure_ohos_host_display');
  late final _wire_main_configure_ohos_host_display =
      _wire_main_configure_ohos_host_displayPtr
  ...
  late final _wire_main_set_ohos_host_clipboard_enabledPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Bool)>>(
  ...
  late final _wire_main_update_ohos_host_clipboard_text =
      _wire_main_update_ohos_host_clipboard_textPtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();
  ...
  WireSyncReturn wire_main_ohos_host_is_started() {
    return _wire_main_ohos_host_is_started();
  }

  late final _wire_main_ohos_host_is_startedPtr =
      _lookup<ffi.NativeFunction<WireSyncReturn Function()>>(
  ...
  void wire_cm_close_connection_window(int port_, int conn_id) {
    return _wire_cm_close_connection_window(port_, conn_id);
  }
...
const int MOUSE_TYPE_MOVE = 0;

const int MOUSE_TYPE_DOWN = 1;

const int MOUSE_TYPE_UP = 2;

const int MOUSE_TYPE_WHEEL = 3;

const int MOUSE_TYPE_TRACKPAD = 4;

const int MOUSE_TYPE_MOVE_RELATIVE = 5;

const int MOUSE_TYPE_MASK = 7;

const int MOUSE_BUTTON_LEFT = 1;

const int MOUSE_BUTTON_RIGHT = 2;

const int MOUSE_BUTTON_WHEEL = 4;

const int MOUSE_BUTTON_BACK = 8;

const int MOUSE_BUTTON_FORWARD = 16;

const int MAX_TEXT_BYTES = 65536;
...
const int CAPITAL = 20;

const int KANA = 21;

const int HANGEUL = 21;
...
const int EXECUTE = 43;

const int SNAPSHOT = 44;
...
const int NUMPAD0 = 96;

const int NUMPAD1 = 97;

const int NUMPAD2 = 98;

const int NUMPAD3 = 99;

const int NUMPAD4 = 100;

const int NUMPAD5 = 101;

const int NUMPAD6 = 102;

const int NUMPAD7 = 103;

const int NUMPAD8 = 104;

const int NUMPAD9 = 105;

const int MULTIPLY = 106;

const int ADD = 107;

const int SEPARATOR = 108;

const int SUBTRACT = 109;

const int DECIMAL = 110;

const int DIVIDE = 111;
...
const int NUMLOCK = 144;

const int SCROLL = 145;

const int LSHIFT = 160;

const int RSHIFT = 161;

const int LCONTROL = 162;

const int RCONTROL = 163;

const int LMENU = 164;

const int RMENU = 165;

const int OEM_NEC_EQUAL = 146;

const int VOLUME_MUTE = 173;
...
const int NATIVE_INPUT_IMPLEMENTED = 1;

const int NATIVE_BACKEND_IMPLEMENTED = 1;
